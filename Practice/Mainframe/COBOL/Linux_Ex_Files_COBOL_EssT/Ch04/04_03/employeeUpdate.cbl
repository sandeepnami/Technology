       ...
       0100-READ-EMPLOYEES.
		   ...
		   PERFORM 0150-UPDATE-START-DATE.
           CLOSE EMPLOYEEFILE.
	   ...
	   0100-END.
       0150-UPDATE-START-DATE.
       		READ EMPLOYEEFILE
			   AT END SET ENDOFFILE TO TRUE
			END-READ.
            PERFORM UNTIL ENDOFFILE 
               MOVE '20200701' TO STARTDATE
               REWRITE EMPDETAILS FROM EMPDETAILS
               READ EMPLOYEEFILE 
