       ...
       PROGRAM-ID. PROBLEMSOLVESTART.

       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
	   SELECT EMPLOYEEFILE ASSIGN TO "TESTDATA.DAT"
       ...
       0250-VALIDATE-EMAIL.
           MOVE 0 TO WS-TALLY-ATSIGN.
           INSPECT EMAIL TALLYING WS-TALLY-ATSIGN FOR ALL '@'.
           IF WS-TALLY-ATSIGN NOT = 1
