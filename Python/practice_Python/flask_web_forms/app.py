...
from wtforms.validators import input_required, DataRequired, Length
...
class NewItemForm(FlaskForm):
    title       = StringField("Title", validators=[input_required("Input is required!"), DataRequired("Data is required!"), Length(min=5,max=20,message="Input must be between 5 and 20 characters")])
